...
import { Trash2, Plus, Truck, User, Loader2, ArrowRight, ScanLine, Search, PackageSearch } from "lucide-react";
          ...
          <div className="flex gap-3">
            ...
            <Dialog open={isScannerOpen} onOpenChange={setIsScannerOpen}>
              ...
              <DialogContent className="max-w-md rounded-[2.5rem] bg-card/90 backdrop-blur-3xl">
                ...
                <div id="reader-out-page" className="w-full overflow-hidden rounded-2xl border-2 border-dashed border-rose-500/20 bg-background/50"></div>
              </DialogContent>
            </Dialog>
          </div>
        </header>
              ...
              <CardContent className="p-8 pt-0 grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <Input 
                    ...
                    className="h-14 rounded-2xl bg-background/50 border-border/40 font-bold focus:ring-rose-500/40 transition-all" 
                    value={orderNumber} 
                              ...
                              {products?.filter(p => 
                                ...
                                <SelectItem key={p.id} value={p.id} className="py-3 cursor-pointer">
                                  <div className="flex flex-col">
                                    ...
                                    <span className="text-[9px] opacity-50 uppercase tracking-widest font-black">{p.sku} ({p.stock} ta mavjud)</span>
                                  </div>
                                </SelectItem>
                              ))}
                            </div>
          ...
          <div className="lg:col-span-4 space-y-8">
            <Card className="border-none glass-card bg-rose-600 text-white rounded-[3rem] shadow-2xl shadow-rose-600/30 sticky top-8 overflow-hidden">
                ...
                <div className="space-y-4">
                   <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <p className="text-[10px] font-black uppercase opacity-50">Qabul qiluvchi</p>
              ...
              <CardFooter className="p-8 pt-0">
                <Button 
                  className="w-full h-16 rounded-2xl bg-white text-rose-600 hover:bg-white/90 font-black uppercase tracking-[0.2em] text-[12px] shadow-2xl border-none premium-button" 
