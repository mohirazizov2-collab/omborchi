...
import { Warehouse, MapPin, Phone, User, MoreVertical, Plus } from "lucide-react";
    ...
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        <header className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold font-headline tracking-tight text-primary">Warehouses</h1>
            <p className="text-muted-foreground mt-1">Manage and monitor all your storage facilities.</p>
          </div>
        ...
        <div className="mb-6 flex gap-4">
          <Input placeholder="Search warehouses..." className="max-w-md bg-card" />
                ...
                <div className="mt-4 space-y-3">
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center gap-2 text-muted-foreground">
                      <User className="w-4 h-4" /> <span>Manager:</span>
                    </div>
                  ...
                  <div className="pt-4 border-t mt-4 flex justify-between items-center">
                    <div className="space-y-1">
                      <p className="text-[10px] text-muted-foreground uppercase font-semibold">Stock Utilization</p>
