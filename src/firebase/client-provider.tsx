...
export function FirebaseClientProvider({ children }: FirebaseClientProviderProps) {
  ...
  const isCompanyLoginRoute = /^\/[a-z0-9]+(?:-[a-z0-9]+)*$/.test(pathname);
  const isPublicRoute = pathname === '/login' || isCompanyLoginRoute;
  ...
  }, [user, isInitialized, mounted, pathname, router, isPublicRoute]);
